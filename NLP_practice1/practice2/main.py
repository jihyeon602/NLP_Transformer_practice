...
def main():
    ...
    with codecs.open("practice2/data/text8_1m_part_aa.txt", "r", "utf-8") as html_f:
    ...
    # 각 사전들의 단어 개수를 출력합시다.
    print("# 단어등장횟수 word_dict1: {}".format(len(word_dict1)))
    print("# stop_word 제거 word_dict2: {}".format(len(word_dict2)))
    print("# 횟수제한 word_dict3: {}".format(len(word_dict3)))
