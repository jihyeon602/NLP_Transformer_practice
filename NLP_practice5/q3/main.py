...
with open('NLP_practice5/q3/bow_models.pkl', 'rb') as f:
...
print("vec1 vs vec2 유사도:",sim1) #[[0.00936629]]

# vec1과 행렬 X의 첫 번째 문서 벡터 간 코사인 유사도를 변수 sim2에 저장합니다.
sim2 = cosine_similarity(vec1, X[0]) #[[0.04116601]]
# X의 첫 번째 문서와 vec1의 코사인 유사도를 확인해봅니다.
print("vec1 vs X[0] 유사도:",sim2) 