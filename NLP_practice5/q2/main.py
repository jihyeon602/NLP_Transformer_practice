...
with open("NLP_practice5/q2/text.txt", 'r', encoding='utf-8') as f:
    documents = []
    for line in f:
...
X = tfid.fit_transform(documents)
...
tfid2 = TfidfVectorizer(ngram_range=(1, 2)) #데이터 내 unigram과 bigram을 사용하여 문서 벡터를 생성
unibigram_X = tfid2.fit_transform(documents)
